...
void DebugScene::init(){
    ...
    testObject.initObject(skullMesh);
    testObject.initTextures(1, "assets/Skull.png");
    testObject.setScale(glm::vec3(0.1f));
    ...
    testObject2.initShaders(2, "assets/shaders/testVertexShader.vs", "assets/shaders/testFragShader.fs");

    testObject2.initObject(vertices, sizeof(vertices));
    testObject2.initTextures(1, "assets/texture.png");
    testObject2.setScale(glm::vec3(0.6f));
...
void DebugScene::update(){
    ...
    glm::vec3 newPos = lights[0].position;
    newPos.x = 2*sin((float)glfwGetTime()*3);
    newPos.z = 2*cos((float)glfwGetTime()*3);
    lights[0].position = newPos;
    lightDebugObjects[0].setPos(lights[0].position);
